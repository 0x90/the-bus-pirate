...
namespace ds30Loader
{
	...
	public class clsHex
	{
		...
		// GetBootloaderEndRow()
		//---------------------------------------------------------------------
		virtual public int GetBootloaderEndRow( clsParseSettings pobjParseSettings ) 
		{
        ...
        //---------------------------------------------------------------------
		// GetBootloaderStartAdress()
		//---------------------------------------------------------------------
		virtual public int GetBootloaderStartAdress( clsParseSettings pobjParseSettings ) 
		{
			clsDevice objDev = pobjParseSettings.device;
            return objDev.flashSizeP - pobjParseSettings.blPlacementP * objDev.pageSizeR * objDev.rowsizeW * 2/*word->pcu*/;
        }// GetBootloaderStartAdress()
		...
		//---------------------------------------------------------------------
		virtual public int GetBootloaderStartRow( clsParseSettings pobjParseSettings ) 
		{
			return GetBootloaderStartAdress(pobjParseSettings) / ( 2 * pobjParseSettings.device.rowsizeW );
        }// GetBootloaderStartRow()
